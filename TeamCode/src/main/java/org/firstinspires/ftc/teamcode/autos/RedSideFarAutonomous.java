...
@Config
@Autonomous(name = "RED_FAR_RR", group = "Autonomous")
public class RedSideFarAutonomous extends LinearOpMode {
    public class Lift {
    ...
    public void runOpMode() {
        ...
        Action trajectoryAction3 = drive.actionBuilder(drive.pose)
                .lineToY(-37.5)
                .turnTo(Math.toRadians(177-180))
                .setTangent(Math.toRadians(90))
                .lineToY(-34)
                .setTangent(0)
                .lineToX(14)
                .build();
        Action trajectoryAction3Pt2 = drive.actionBuilder(new Pose2d(14, 34, Math.toRadians(180)))
                .waitSeconds(2)
                .lineToX(50)
                .setTangent(Math.toRadians(90))
                .lineToY(27)
                .build();
        Action trajectoryActionCloseOut3 = drive.actionBuilder(new Pose2d(48, 27, Math.toRadians(180)))
                .lineToX(46)
                .setTangent(Math.toRadians(90))
                .lineToY(12)
                .setTangent(0)
                .lineToX(48)
                .build();
        Action trajectoryActionCloseOut1 = drive.actionBuilder(new Pose2d(48, 42, Math.toRadians(180)))
                .lineToX(46)
                .setTangent(Math.toRadians(90))
                .lineToY(12)
                .setTangent(0)
                .lineToX(48)
                .build();
        Action trajectoryActionCloseOut2 = drive.actionBuilder(new Pose2d(48, 35, Math.toRadians(180)))
                .lineToX(46)
                .setTangent(Math.toRadians(90))
                .lineToY(12)
                .setTangent(0)
